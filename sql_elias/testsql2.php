...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM producten WHERE product_name LIKE '%$product_name%' OR abbreviated_product_name LIKE '%$product_name%' OR generic_name LIKE '%$product_name%'";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["carbon_footprint_100g"]. "</td>";
