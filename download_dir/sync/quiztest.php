            ...
            <form action="quiztest.php" method="post">
                ...
                <div class="Q3">
                    ...
                    <ul class="options3">
                        ...
                        <button class="test_button" onclick="add_co2(10)" name="q3" value="1">1 - 10 litre</button><br>
                        <button class="test_button" onclick="add_co2(20)" name="q3" value="2">10 - 20 litre</button><br>
                        <button class="test_button" onclick="add_co2(30)" name="q3" value="3">20 - 30 litre</button><br>
                        <button class="test_button" onclick="add_co2(40)" name="q3" value="4">40 - 50 litre</button><br>
                        <button class="test_button" onclick="add_co2(50)" name="q3" value="5">50+ litre</button><br>
                        <button class="test_button" name="q3" value="6">I don't have a car</button><br>
                        <button class="test_button" name="q3" value="7">I only travel by public transport</button><br>
                    </ul>
                </div>
                <div class="Q4">
                ...
                <div class="Q7">
                    ...
                    <ul class="options7">
                        ...
                        <button class="test_button" name="q7" value="1" onclick="add_co2(900 * 1.78)">Up to 900m3</button><br>
                    <button class="test_button" name="q7" value="2" onclick="add_co2(1500 * 1.78)">900 m3 - 1500 m3</button><br>
                    <button class="test_button" name="q7" value="3" onclick="add_co2(2000 * 1.78)">1500 m3 - 2000 m3</button><br>
                    <button class="test_button" name="q7" value="4" onclick="add_co2(2500 * 1.78)">More than 2000 m3</button><br>
                    <button class="test_button" name="q7" value="5" onclick="add_co2(1750 * 1.78)">I don't know</button><br>
                    </ul>
                </div>
                <div class="Q8">
                    ...
                    <ul class="options8">
                        ...
                        <button class="test_button" name="q8" value="1" onclick="add_co2(2000 * 0,37)">Up to 2000 kWh</button><br>
                        <button class="test_button" name="q8" value="2" onclick="add_co2(2500 * 0,37)">2000 - 2500 kWh</button><br>
                        <button class="test_button" name="q8" value="3" onclick="add_co2(3000 * 0,37)">2500 - 3000 kWh</button><br>
                        <button class="test_button" name="q8" value="4" onclick="add_co2(3500 * 0,37)">3000 - 3500 kWh</button><br>
                        <button class="test_button" name="q8" value="5" onclick="add_co2(4000 * 0,37)">3500 - 4000 kWh</button><br>
                        <button class="test_button" name="q8" value="6" onclick="add_co2(4500 * 0,37)">4000 kWh or more</button><br>
                        <button class="test_button" name="q8" value="7" onclick="add_co2(3500 * 0,37)">I don't know</button><br>
                    </ul>
                </div>
                <div class="Q9">
